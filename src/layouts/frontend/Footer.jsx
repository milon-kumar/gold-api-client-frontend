...
export default function Footer({ websiteSettings, webPages }) {
  ...
  return (
    <footer className="border-t border-border/50 bg-amber-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-16">
        <div className="grid sm:grid-cols-2 lg:grid-cols-5 gap-10">
          ...
          <div className="lg:col-span-2">
            <div className="flex items-center gap-3 mb-4">
              ...
              <Link
                to="/"
                className="flex items-center gap-3 py-1 rounded-sm"
              >
                <img
            ...
            <div className="flex flex-col gap-2 mt-6 text-sm text-muted-foreground">
              <a
                href="#"
                className="flex items-center gap-2 hover:text-primary transition-colors font-bengali"
              >
              ...
              <div key={link?.page?.id}>
                ...
                <ul className="space-y-2.5">
                  {link?.children?.map((child) => {
                    const isCustomLink = child?.page_type === "link";
                    ...
                    return (
                      <li key={child?.id}>
                        <a
                          href={url}
                          target={isCustomLink ? "_blank" : undefined}
        ...
        <div className="mt-12 pt-8 border-t border-border/50 flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-6">
            <a
              href="#"
              className="text-xs text-muted-foreground hover:text-primary transition-colors font-bengali"
            >
              গোপনীয়তা নীতি
            </a>
            <a
