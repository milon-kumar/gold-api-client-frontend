...
// }
const socialIcons = [
    { Icon: FiFacebook, bg: "bg-[#1877F2]" },
    { Icon: FiYoutube, bg: "bg-[#FF0000]" },
    { Icon: FiTwitter, bg: "bg-[#1DA1F2]" },
];


export function SingleCard({ name, jobType, email, phone, photo }) {
            ...
            <CardHeader>
                {
                    jobType && (
                        <CardAction className="flex items-center gap-2">
                            <Badge variant="secondary" className={'bg-primary rounded-full text-white'}>{jobType}</Badge>
                        </CardAction>
                    )
                }
                ...
                <CardDescription>
                    {
                        socialIcons.map(({ Icon, bg }, i) => (
                            <Button
                                key={i}
                                className={`rounded-sm text-white ${bg} hover:opacity-80`}
                            >
                                <Icon />
                            </Button>
                        ))
