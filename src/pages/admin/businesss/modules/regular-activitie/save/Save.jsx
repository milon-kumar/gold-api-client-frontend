...
const Save = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (response?.success) {
                toast.success(response?.message || "Regular activity saved successfully");
                navigate('/admin/regular-activities');
            } else {
                toast.error(response?.message || "Failed to save regular activity");
            }
        } catch (error) {
            console.error('Error saving regular activity:', error);
            toast.error('Error saving regular activity data');
        } finally {
            setSaving(false);
        }
    };
    ...
    return (
        <div className="min-h-screen bg-gray-50">
            <PageHeader
                title={id && id !== 'new' ? 'Edit Regular Activity' : 'Add New Regular Activity'}
                subtitle={id && id !== 'new' ? `Update regular activity information` : `Add a new regular activity to the module`}
                showBackButton={true}
                onBackClick={() => navigate('/admin/regular-activities')}
                primaryAction={{
                    ...
                    <div className="lg:col-span-2 space-y-6">
                        ...
                        <Card className="shadow-sm">
                            <CardHeader className="border-b bg-gray-50/50">
                                ...
                                <CardDescription>
                                    Enter the regular activity details
                                </CardDescription>
                            </CardHeader>
