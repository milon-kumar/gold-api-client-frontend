...
const List = () => {
    ...
    const handleEditItem = (item) => {
        navigate(`/admin/module/${moduleSlug}/${item?.id}`);
    };
    ...
    return (
        <div className="min-h-screen bg-gray-50">
            <PageHeader
                ...
                primaryAction={{
                    title: `Add ${moduleSlug}`,
                    icon: "plus",
                    onClick: () => navigate(`/admin/module/${moduleSlug}/new`)
                }}
                secondaryAction={{
                    title: "Refresh",
                    icon: "refresh",
            ...
            {itemsLoading ? (
                ...
                <Card>
                    <CardContent className="flex flex-col items-center justify-center py-12">
                        ...
                        <p className="text-muted-foreground">No {moduleSlug} found</p>
                        <Button
                            variant="link"
                            onClick={() => navigate(`/admin/module/${moduleSlug}/new`)}
                            className="mt-2"
                        >
                            Add your first {moduleSlug}
                        </Button>
                    </CardContent>
                </Card>
            ) : (
