...
const Save = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response?.success) {
        toast.success(response?.message || "Founding President saved successfully");
        await refetchItem();
        setIsEditing(true);
        if (response?.data?.id) {
        ...
        toast.error(response?.message || "Failed to save founding president");
      }
    } catch (error) {
      console.error('Error saving founding president:', error);
      toast.error('Error saving founding president data');
    } finally {
      setSaving(false);
    }
  };
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <PageHeader
        title={isEditing ? 'Update Founding President' : 'Create Founding President'}
        subtitle={isEditing ? 'Update the founding president\'s information' : 'Add information about the founding president'}
          ...
          <div className="lg:col-span-2 space-y-6">
            <Card className="shadow-sm">
              <CardHeader className="border-b bg-gray-50/50">
                ...
                <CardDescription>
                  Enter the founding president's information and legacy
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-4 pt-6">
                <div>
                  ...
                  <Input
                    ...
                    placeholder="e.g., Founding President, Our Founder, The Visionary"
                    className="mt-1.5"
                  />
                </div>
                ...
                <div>
                  ...
                  <Input
                    ...
                    onChange={handleInputChange}
                    placeholder="e.g., The Vision Behind Our Success, A Legacy of Excellence"
                    className="mt-1.5"
                  />
                </div>
                ...
                <div>
                  ...
                  <Textarea
                    ...
                    onChange={handleInputChange}
                    placeholder="Enter a brief introduction about the founding president"
                    rows="3"
                    className="mt-1.5"
                  />
                </div>
          ...
          <div className="lg:col-span-1 space-y-6">
            <Card className="shadow-sm">
              <CardHeader className="border-b bg-gray-50/50">
                ...
                <CardDescription>
                  Upload the founding president's photo (Max {setting?.setting?.item?.image_size || 5}MB)
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-4 pt-6">
                {preview ? (
                  <div className="relative">
                    <div className="relative overflow-hidden rounded-lg border bg-gray-50">
                      <div className="flex h-72 w-full items-center justify-center bg-gray-100">
                        <img
                          src={preview}
                          alt="Founding President Preview"
            ...
            <Card className="shadow-sm border-amber-200 bg-amber-50/30">
              ...
              <CardContent className="space-y-2 text-sm">
                <ul className="list-disc list-inside space-y-1 text-muted-foreground">
                  <li>Highlight the founding president's vision and mission</li>
                  <li>Share key achievements and milestones</li>
                  <li>Mention their leadership style and values</li>
                  <li>Include inspiring quotes or stories</li>
                  <li>Show their lasting impact on the organization</li>
                </ul>
              </CardContent>
            </Card>
          </div>
