...
const AnnualPlansListing = () => {
    ...
    const handleDelete = async () => {
        try {
            ...
            if (response?.success) {
                toast.success(response?.message || "Annual plan deleted successfully");
                await refetchItems();
            ...
            toast.error("Failed to delete annual plan");
        }
    };
    ...
    const handleEditItem = (item) => {
        navigate(`/admin/annual-plans/save/${item?.id}`);
    };
            ...
            <Dialog open={open} onOpenChange={onOpenChange}>
                <DialogContent className="max-w-3xl">
                    <DialogHeader>
                        ...
                        <DialogDescription>
                            Complete information about the annual plan
                        </DialogDescription>
                    </DialogHeader>
    ...
    return (
        <div className="min-h-screen bg-gray-50">
            <PageHeader
                title="Annual Plans"
                subtitle={`Manage your annual plans (${items.length} total)`}
                primaryAction={{
                    title: "Add Annual Plan",
                    icon: "plus",
                    onClick: () => navigate("/admin/annual-plans/save")
                }}
                secondaryAction={{
                    title: "Refresh",
                    icon: "refresh",
            ...
            {itemsLoading ? (
                ...
                <Card>
                    <CardContent className="flex flex-col items-center justify-center py-12">
                        ...
                        <p className="text-muted-foreground">No annual plans found</p>
                        <Button
                            variant="link"
                            onClick={() => navigate("/admin/annual-plans/save")}
                            className="mt-2"
                        >
                            Create your first annual plan
                        </Button>
                    </CardContent>
                </Card>
            ) : (
...
export default AnnualPlansListing;