...
const SlidersListing = () => {
  ...
  const filteredSliders = sliders.filter((slider) => {
    const languageMatch =
      selectedLanguage === "all" || slider.lang_slug === selectedLanguage;
    const schoolMatch =
      selectedSchool === "all" || slider.school_id === parseInt(selectedSchool);
  ...
  const {
    ...
    url: `/admin/business-module-items/${selectedSlider?.id}`,
    method: "DELETE",
  });
    ...
    return (
      <Card className="group relative overflow-hidden cursor-pointer rounded-xl border-0 bg-white pt-0 shadow-sm transition-all duration-300">
        <div className="relative overflow-hidden">
          ...
          {slider.is_featured == 1 && <FeaturedBadge />}
        ...
        <CardContent>
          <div>
            <h3 className="line-clamp-1 text-lg font-bold">{slider.title}</h3>
            ...
            >
              ...
              <TableCell className="min-w-[280px]">
                <div className="space-y-1">
                  <h4 className="font-semibold line-clamp-1">{slider.title}</h4>
              ...
              <TableCell>
                <div className="flex flex-col gap-1">
                  <Badge variant="outline">
                    {slider.meta?.primary_button_title || "Read More"}
                  </Badge>
      ...
      <Dialog open={openViewModal} onOpenChange={() => setOpenViewModal(null)}>
        <DialogContent className="max-w-3xl">
          <DialogHeader>
            ...
            <DialogDescription>View slider details and image</DialogDescription>
          </DialogHeader>
          {selectedSlider && <SliderGridCard slider={selectedSlider} />}
        </DialogContent>
      </Dialog>
