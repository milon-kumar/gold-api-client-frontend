  ...
  return (
    <div>
      <PageHeader
        ...
        subtitle={
          id && id !== "new"
            ? `Update your slider content and settings`
            : `Add a new slider to your module`
        }
              ...
              <CardContent className="space-y-4">
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      handleMetaChange("primary_button_title", e.target.value)
                    }
          ...
          <div className="space-y-6">
              ...
              <CardContent className="space-y-5">
                  ...
                  <div className="flex items-start justify-between gap-4">
                    <div>
                      <div className="flex items-center gap-2">
                        ...
                        <div>
                          <h4 className="font-semibold">Featured Item</h4>
                ...
                <div className="rounded-xl border p-4">
                  <div className="mb-3 flex items-center justify-between">
                    <div>
                      <h4 className="font-semibold">Publication Status</h4>
            ...
            <Card className="shadow-sm">
              ...
              <CardContent className="space-y-4">
                <div>
                  <Label
                    htmlFor="secondary_button_title"
                    className="text-sm font-semibold"
                  >
                    Button Title
                  </Label>
                  <Input
                    ...
                    onChange={(e) =>
                      handleMetaChange("secondary_button_title", e.target.value)
                    }
