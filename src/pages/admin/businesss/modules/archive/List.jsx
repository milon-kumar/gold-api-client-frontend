...
const ArchivesListing = () => {
    ...
    const handleEditItem = (item) => {
        navigate(`/admin/archives/save/${item?.id}`);
    };
            ...
            <Dialog open={open} onOpenChange={onOpenChange}>
                <DialogContent className="max-w-2xl">
                    <DialogHeader>
                        ...
                        <DialogDescription>
                            Complete information about the archive
                        </DialogDescription>
                    </DialogHeader>
    ...
    return (
        <div className="min-h-screen bg-gray-50">
            <PageHeader
                title="Archives"
                subtitle={`Manage your archives (${items.length} total)`}
                primaryAction={{
                    title: "Add Archive",
                    icon: "plus",
                    onClick: () => navigate("/admin/archives/save")
                }}
                secondaryAction={{
                    title: "Refresh",
                    icon: "refresh",
            ...
            <div className="mb-6 flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
                ...
                <div className="text-sm text-muted-foreground">
                    {items.length} archive{items.length !== 1 ? 's' : ''} found
                </div>
            </div>
