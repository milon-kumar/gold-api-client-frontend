...
const SocialActivitiesListing = () => {
  ...
  const handleDelete = async () => {
    try {
      ...
      if (response?.success) {
        toast.success(response?.message || "Social activity deleted successfully");
        await refetchItems();
      ...
      toast.error("Failed to delete social activity");
    }
  };
  ...
  const handleEditItem = (item) => {
    navigate(`/admin/social-activities/save/${item?.id}`);
  };
      ...
      <Dialog open={open} onOpenChange={onOpenChange}>
        <DialogContent className="max-w-2xl">
          <DialogHeader>
            ...
            <DialogDescription>
              Complete information about the social activity
            </DialogDescription>
          </DialogHeader>
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <PageHeader
        ...
        subtitle={`Manage your social activities (${items.length} total)`}
        primaryAction={{
          title: "Add Activity",
          icon: "plus",
          onClick: () => navigate("/admin/social-activities/save")
        }}
        secondaryAction={{
          title: "Refresh",
          icon: "refresh",
      ...
      {itemsLoading ? (
        ...
        <Card>
          <CardContent className="flex flex-col items-center justify-center py-12">
            ...
            <p className="text-muted-foreground">No social activities found</p>
            <Button
              variant="link"
              onClick={() => navigate("/admin/social-activities/save")}
              className="mt-2"
            >
              Create your first social activity
            </Button>
          </CardContent>
        </Card>
      ) : (
...
export default SocialActivitiesListing;