...
const Save = () => {
  ...
  const {
    ...
    url: `/admin/business-modules/${MODULES?.INTRODUCTION}`,
    params: {
      module_slug: MODULES?.INTRODUCTION || 'introduction',
      limit: 1,
    }
  });
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response?.success) {
        toast.success(response?.message || "Introduction saved successfully");
        await refetchItem();
        setIsEditing(true);
        if (response?.data?.id) {
        ...
        toast.error(response?.message || "Failed to save introduction");
      }
    } catch (error) {
      console.error('Error saving introduction:', error);
      toast.error('Error saving introduction data');
    } finally {
      setSaving(false);
    }
  };
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <PageHeader
        title={isEditing ? 'Update Introduction' : 'Create Introduction'}
        subtitle={isEditing ? 'Update the introduction content' : 'Add a new introduction'}
          ...
          <div className="lg:col-span-2 space-y-6">
            <Card className="shadow-sm">
              <CardHeader className="border-b bg-gray-50/50">
                ...
                <CardDescription>
                  Enter the introduction details
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-4 pt-6">
                ...
                <div>
                  ...
                  <p className="text-xs text-muted-foreground mt-1.5">
                    Write the complete description. This will be displayed on the main page.
                  </p>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="shadow-sm border-purple-200 bg-purple-50/30">
              ...
              <CardContent className="space-y-2 text-sm">
                <ul className="list-disc list-inside space-y-1 text-muted-foreground">
                  ...
                  <li>Highlight key information and value</li>
                  <li>Use a professional and welcoming tone</li>
