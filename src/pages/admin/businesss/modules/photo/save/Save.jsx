    ...
    return (
        <div className="min-h-screen bg-gray-50">
            <PageHeader
                ...
                subtitle={id && id !== 'new' ? `Update photo information` : `Add a new photo to the module`}
                showBackButton={true}
                    ...
                    <div className="lg:col-span-1 space-y-6">
                        ...
                        <Card className="shadow-sm">
                            <CardHeader className="border-b bg-gray-50/50">
                                ...
                                <CardDescription>
                                    Upload a photo (Max {setting?.setting?.item?.image_size || 5}MB)
                                </CardDescription>
                            </CardHeader>
                            <CardContent className="space-y-4 pt-6">
                                {currentImagePreview ? (
